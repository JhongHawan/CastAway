  ...
  function ContextCard(props) {
    return (
      <Row style={{ padding: 10 }}>
        <ExpansionPanel style={{ background: '#F2F2F2', height: '100%' }}>
